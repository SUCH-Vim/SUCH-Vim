...
function! SUCHVim_check_dependencie(program)
...
function! SUCHVim_check_dependencies(dependencies)
    ...
    for dependencie in a:dependencies
        if 0 == SUCHVim_check_dependencie(dependencie)
            call add(missing_dependencies, dependencie)
        endif
    endfor
